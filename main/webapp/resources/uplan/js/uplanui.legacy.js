/*! Uplan UI v2.1.0 ~ Old IE Fucker | by Uplan UI Team | (c) 2015 AllMobilize, Inc. | Licensed under MIT | 2015-01-13T02:01:01 UTC */
(function e(t, n, r) {
  function s(o, u) {
    if (!n[o]) {
      if (!t[o]) {
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        var Alert = function(element, options) {
          ...
          this.$element.
          addClass('up-fade am-in').
          on('click.alert.amui', '.up-close', $.proxy(this.close, this));
        };
  ...
  6: [
    function(require, module, exports) {
      (function(global) {
        ...
        Dimmer.DEFAULTS = {
          tpl: '<div class="up-dimmer" data-am-dimmer></div>'
        };
        ...
        Dimmer.prototype.close = function(relatedElement, force) {
          ...
          $element.removeClass('up-active').trigger('close.dimmer.amui');
  ...
  7: [
    function(require, module, exports) {
      (function(global) {
        ...
        // var toggle = '[data-am-dropdown] > .up-dropdown-toggle';
        ...
        Dropdown.prototype.open = function(e) {
          ...
          $element.trigger('open.dropdown.amui').addClass('up-active');
   ...
   .on(eventOut + '.' + eventNS, $.proxy(this.close, this));
        ...
        $(document).on('click.dropdown.amui.data-api', '.up-dropdown form',
          function(e) {
            e.stopPropagation();
          });
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        Modal.prototype.events = function() {
          ...
          $element.find('[data-am-modal-close], .up-modal-btn').
      ...
      (function(global) {
        ...
        Popover.prototype.sizePopover = function sizePopover() {
          ...
          $popover.css({
            ...
            'up-popover-right am-popover-top am-popover-bottom');
